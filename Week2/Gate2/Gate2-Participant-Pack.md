...
10 minutes, 1:1 with your coach.
4 minutes — you present.
3 minutes - you ask the top question that you would ask a COO and based on the answer try to think what would change
3 minutes — coach Q&A.
What to present
A before/after view of your scenario:
Before. The current process. What humans do today, where the cognitive load sits, where the failures and bottlenecks live.
After. The redesigned process with your agent in place. Be explicit about which steps are fully agentic, which remain human, and which are hybrid.
The why. For every step you mark fully agentic, defend the call. What about it makes full delegation safe?

What you are being assessed on
Week 2 content — rigour of your cognitive work mapping, delegation calls, and agent purpose.
Critical thinking — whether you can defend your design, name your assumptions, and acknowledge trade-offs.
Presentation — clarity, structure, and ability to land the key calls inside four minutes.
How to prep
Be ready to defend any boundary you have drawn. Q&A will probe specific choices. Expect to be asked why a step is (or is not) fully agentic, what your design assumes, and where it could break.
Have your delegation matrix, agent purpose document, and use case prioritisation to hand for reference.
