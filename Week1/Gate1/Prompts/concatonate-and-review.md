...
Produce a **single consolidated Gate 1 spec document** for the Gate Scenario by concatenating the five deliverable files already generated in `Week1/Gate1/Output/`, in the exact deliverable order specified by the Gate 1 section of [`Week1/Gate1/SupportingDocs/Gate1-Participant-Pack.md`](../SupportingDocs/Gate1-Participant-Pack.md), 
then review and revise the result against `SupportingDocs/production-spec-checklist.md` and Evaluation criteria in [`Week1/Gate1/SupportingDocs/Gate1-Participant-Pack.md`](../SupportingDocs/Gate1-Participant-Pack.md)

## Inputs

Read all five files from `Week1/Gate1/Output/`:

- `problem-statement-gate-scenario-317.md`
- `delegation-analysis-gate-scenario-503.md`
- `agent-specification-gate-scenario-612.md`
- `validation-design-gate-scenario-729.md`
- `assumptions-and-unknowns-gate-scenario-841.md`

If any of the five is missing, stop and flag the gap — do not fabricate content to fill it.

## Concatenation order (authoritative)

The order is taken from the Gate 1 deliverable list in [`Week1/Gate1/SupportingDocs/Gate1-Participant-Pack.md`](../SupportingDocs/Gate1-Participant-Pack.md), section 4 Deliverables.

1. **Problem statement & success metrics** — from `problem-statement-gate-scenario-317.md`
2. **Delegation analysis** — from `delegation-analysis-gate-scenario-503.md`
3. **Agent specification** — from `agent-specification-gate-scenario-612.md`
4. **Validation design** — from `validation-design-gate-scenario-729.md`
5. **Assumptions & unknowns** — from `assumptions-and-unknowns-gate-scenario-841.md`
...
`Week1/Gate1/Output/chris-edwards-{NNN}.md`

where `{NNN}` is a 3-digit run suffix. Pick the next unused suffix by scanning the folder for existing `chris-edwards-*.md` files and incrementing past the highest numeric suffix present (so iterations sit side-by-side per `CLAUDE.md` → *Output placement*). Do not overwrite previous runs.
...
- One new file exists at `Week1/Gate1/Output/chris-edwards-{NNN}.md`.
- Its section order matches the Gate 1 deliverable order in [`Week1/Gate1/SupportingDocs/Gate1-Participant-Pack.md`](../SupportingDocs/Gate1-Participant-Pack.md), section 4 Deliverables.
